...
export const LinkDesktop = () => {
    ...
    return (
        <Flex
            ...
            w="415px"
        >
            <Button fontSize="xl" fontFamily="heading" color="gray.600" variant="link" _hover={{ color: "gray.50" }} borderBottom="solid 2px" borderRadius="0px" onClick={() => history.push("/dashboard")} >Dashboard</Button>
            <Button fontSize="xl" fontFamily="heading" color="gray.600" variant="link" _hover={{ color: "gray.50" }} borderBottom="solid 2px" borderRadius="0px" onClick={() => history.push("/lancamentos")} >Lançamentos</Button>
            <Button fontSize="xl" fontFamily="heading" color="gray.600" variant="link" _hover={{ color: "gray.50" }} borderBottom="solid 2px" borderRadius="0px" onClick={() => history.push("/limites")} >Limite de gastos</Button>
        </Flex>
    )
};
